package com.example.instagramclonej.adapter;
...
import com.example.instagramclonej.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder>{
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        Picasso.get().load(postArrayList.get(position).downlaodUrl).into(holder.recyclerRowBinding.RecyclerViewImageView);
